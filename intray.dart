    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(0.0, 591.0),
            child:
                // Adobe XD layer: 'add' (group)
                Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(153.0, 173.0),
                  child: SvgPicture.string(
                    _svg_ovbhr2,
                    allowDrawingOutsideViewBox: true,
                  ),
                ...
                Transform.translate(
                  offset: Offset(159.0, 147.0),
                  child: Container(
                    width: 58.0,
                    height: 58.0,
                    decoration: BoxDecoration(
                      borderRadius:
                          BorderRadius.all(Radius.elliptical(29.0, 29.0)),
                      color: const Color(0xffffffff),
                    ),
                  ),
                ),
                Transform.translate(
                  offset: Offset(167.5, 158.5),
                  child: SvgPicture.string(
                    _svg_cv4ss,
                    allowDrawingOutsideViewBox: true,
                  ),
          ...
          Transform.translate(
            offset: Offset(-87.0, -20.0),
            child:
                // Adobe XD layer: 'back' (group)
                Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(107.5, 41.5),
                  child: SvgPicture.string(
                    _svg_81w6xg,
                    allowDrawingOutsideViewBox: true,
                  ),
          ...
          Transform.translate(
            offset: Offset(68.0, 22.0),
            child: Text(
              'search your tasks here...',
              style: TextStyle(
                fontFamily: 'Arial',
                fontSize: 20,
          ...
          Transform.translate(
            offset: Offset(1212.0, 1273.7),
            child:
                // Adobe XD layer: 'pinned' (group)
                Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(-924.0, -497.7),
                  child: Container(
                    width: 40.0,
                    height: 26.0,
                    decoration: BoxDecoration(
...
const String _svg_ovbhr2 =
    '<svg viewBox="153.0 173.0 70.0 38.0" ><path transform="translate(153.0, 173.0)" d="M 70 0 L 0 0 C 0 5.131175994873047 0.9257444143295288 10.10728073120117 2.750499725341797 14.79122161865234 C 4.513346672058105 19.31623458862305 7.036985874176025 23.3801212310791 10.25133514404297 26.86997604370117 C 13.46567535400391 30.35984230041504 17.20872688293457 33.09979248046875 21.37650299072266 35.01374053955078 C 25.69147300720215 36.99527359008789 30.27508735656738 38 34.99999618530273 38 C 39.72490310668945 38 44.30852127075195 36.99527359008789 48.62348556518555 35.01374053955078 C 52.79126358032227 33.09979248046875 56.53431701660156 30.35984230041504 59.74865341186523 26.86997604370117 C 62.96300506591797 23.3801212310791 65.48664855957031 19.31623458862305 67.24949645996094 14.79122161865234 C 69.07447814941406 10.10669898986816 69.9998779296875 5.130584716796875 70 0.0011138916015625 L 70 0 Z" fill="#f9fafc" fill-opacity="0.63" stroke="none" stroke-width="1" stroke-opacity="0.63" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_cv4ss =
    '<svg viewBox="167.5 158.5 41.0 35.0" ><path transform="translate(187.5, 158.5)" d="M 0 0 L 0 35" fill="none" stroke="#000000" stroke-width="7" stroke-miterlimit="4" stroke-linecap="round" /><path transform="translate(167.5, 176.5)" d="M 0 0 L 41 0" fill="none" stroke="#000000" stroke-width="7" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_81w6xg =
    '<svg viewBox="107.5 41.5 27.0 31.0" ><path transform="translate(107.5, 41.5)" d="M 0 15 L 15 0" fill="none" stroke="#ffffff" stroke-width="4" stroke-miterlimit="4" stroke-linecap="round" /><path transform="translate(107.5, 57.5)" d="M 0 0 L 15 15" fill="none" stroke="#ffffff" stroke-width="4" stroke-miterlimit="4" stroke-linecap="round" /><path transform="translate(107.5, 57.5)" d="M 0 0 L 27 0" fill="none" stroke="#ffffff" stroke-width="4" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_imjzqd =
    '<svg viewBox="323.5 21.5 32.0 26.0" ><path transform="translate(323.5, 21.5)" d="M 0 0 L 32 0" fill="none" stroke="#ffffff" stroke-width="3" stroke-miterlimit="4" stroke-linecap="round" /><path transform="translate(323.5, 34.5)" d="M 0 0 L 32 0" fill="none" stroke="#ffffff" stroke-width="3" stroke-miterlimit="4" stroke-linecap="round" /><path transform="translate(323.5, 47.5)" d="M 0 0 L 32 0" fill="none" stroke="#ffffff" stroke-width="3" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_nm33eu =
    '<svg viewBox="-917.8 -494.0 28.3 18.2" ><path transform="matrix(0.997564, -0.069756, 0.069756, 0.997564, -917.8, -485.37)" d="M 0 0 L 9 9" fill="none" stroke="#ffffff" stroke-width="3" stroke-miterlimit="4" stroke-linecap="round" /><path transform="matrix(0.99863, 0.052336, -0.052336, 0.99863, -907.5, -493.96)" d="M 0 17.29168701171875 L 18 0" fill="none" stroke="#ffffff" stroke-width="3" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
const String _svg_tbxjbm =
    '<svg viewBox="47.3 775.7 45.8 28.9" ><path transform="matrix(1.0, 0.0, 0.0, 1.0, 33.0, 739.57)" d="M 23.0481014251709 64.99980163574219 C 22.49640083312988 64.99980163574219 22.0482006072998 64.55249786376953 22.0482006072998 63.99990081787109 L 22.0482006072998 55.70730209350586 L 18.35460090637207 55.70730209350586 C 14.31630039215088 55.70730209350586 12.82229995727539 50.40450286865234 16.26570129394531 48.29580307006836 L 35.17380142211914 36.72000122070313 C 36.45540237426758 35.93519973754883 38.06909942626953 35.93519973754883 39.35070037841797 36.72000122070313 L 58.25790023803711 48.29580307006836 C 61.70220184326172 50.40450286865234 60.20730209350586 55.70730209350586 56.16990280151367 55.70730209350586 L 52.27289962768555 55.70730209350586 L 52.27289962768555 63.99990081787109 C 52.27289962768555 64.55249786376953 51.82469940185547 64.99980163574219 51.27300262451172 64.99980163574219 L 23.0481014251709 64.99980163574219 Z" fill="none" stroke="#ffffff" stroke-width="2" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
